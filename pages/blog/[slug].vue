<template>
    <div class="main-container">
        <Header />
        <Breadcrumbs :items="slug" breadcrumbTitle="Blog Details" />
                            ...
                            <div class="single-blog-item  wow move-up">
                                ...
                                <div class="post-info lg-blog-post-info">
                                    <div class="post-categories text-center">
                                        <nuxt-link to="/blog">{{ data.category }}</nuxt-link>
                                    </div>
                                    ...
                                    <div class="post-meta mt-20 justify-content-center">
                                        ...
                                        <div class="post-comments">
                                            ...
                                            <nuxt-link to="/" class="smooth-scroll-link">4 Comments</nuxt-link>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="entry-post-tags">
                                                        ...
                                                        <div class="tagcloud">
                                                            <nuxt-link to="/it-services">IT Service</nuxt-link>
                                                            <nuxt-link to="/it-services">IT Service</nuxt-link>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="related-posts-wrapper">
                                            ...
                                            <div class="row mtn-30">
                                                <div class="col-lg-6 mt-30">
                                                    ...
                                                    <nuxt-link to="/blog/blog-details" class="single-valid-post-wrapper">
